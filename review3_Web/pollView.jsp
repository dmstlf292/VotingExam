...
<%
		...
		PollListBean plBean = mgr.getPoll(tlistNum);
		Vector<PollItemBean> vlist= mgr.getView(tlistNum);
		int sumCnt = mgr.sumCount(tlistNum);
		int maxCnt = mgr.getMaxCount(tlistNum);
%> 
<!doctype html>
    ...
    <div id="left-sidebar" class="sidebar ">
        ...
        <nav id="left-sidebar-nav" class="sidebar-nav">
            <ul class="metismenu">
                ...
                <li><a onClick="javascript:location.href='pollView.jsp'"><i class="fa fa-calendar-check-o"></i><span>투표결과보기</span></a></li>
            </ul>
        </nav>        
    </div>
    <div class="page">
                    ...
                    <div class="col-xl-4 col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Question : <%=plBean.getTquestion()%></h3>
                            ...
                            <div class="card-body">
                                <div class="row text-center">
                                    <div class="col-4 border-right pb-4 pt-4">
                                        ...
                                        <h4 class="font-30 font-weight-bold text-col-blue counter"><b><%=sumCnt%></b></h4>
                                    </div>  
                                </div>
                            </div>
                                ...
                                <table class="table table-striped table-vcenter mb-0">
                                    <tbody>
	                                    ...
	                                    <tr>
                                            <td>
                                                <div class="clearfix">
                                                    <div class="float-left"><%=count%> (<%=ratio %>%)</div>
                                                    <div class="float-right"><small class="text-muted"><%if(maxCnt==count){%><font color="red"><b><%}%>
                                    				<%=titem[0]%>
                                    			<%if(maxCnt==count){%></b></font><%}%></small></div>
                                                </div>
